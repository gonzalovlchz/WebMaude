"""
Django settings for WebMaude project.
...
SECRET_KEY = 'django-insecure-aixt!!@k_)jmj6khwvbj62+)trc(08+nm1mjib7f86)v^u9m4p'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['*']
CSRF_TRUSTED_ORIGINS = ['https://maude.piso.gonzalovilchez.es']
...
WSGI_APPLICATION = 'WebMaude.wsgi.application'
